...
public class AppUser {
    ...
    private Set<DateHistory> datehistorys;

    public AppUser() {
        this.roles = new HashSet<>();
        this.datehistorys = new HashSet<>();
    }
    ...
    public void addDateHistory(DateHistory dateHistory) {
        this.datehistorys.add(dateHistory);
    }
    ...
    public Set<DateHistory> getDatehistorys() {
        return datehistorys;
    }

    public void setDatehistorys(Set<DateHistory> datehistorys) {
